...
export const EGYPT_GOVERNORATES = [
  { governorate: 'القاهرة', cities: ['القاهرة', 'مدينة نصر', 'مصر الجديدة', 'المعادي', 'حلوان', 'الزمالك', 'شبرا', 'العباسية', 'التحرير', 'وسط البلد'] },
  { governorate: 'الجيزة', cities: ['الجيزة', 'الهرم', 'فيصل', 'أكتوبر', 'الشيخ زايد', 'الدقي', 'المهندسين', 'إمبابة'] },
  { governorate: 'الإسكندرية', cities: ['الإسكندرية', 'سيدي بشر', 'ميامي', 'العجمي', 'المنتزه', 'برج العرب'] },
  { governorate: 'القليوبية', cities: ['بنها', 'شبرا الخيمة', 'القناطر الخيرية', 'الخانكة'] },
  { governorate: 'الغربية', cities: ['طنطا', 'المحلة الكبرى', 'كفر الزيات', 'زفتى'] },
  { governorate: 'المنوفية', cities: ['شبين الكوم', 'السادات', 'منوف', 'أشمون'] },
  { governorate: 'الدقهلية', cities: ['المنصورة', 'ميت غمر', 'السنبلاوين', 'بلقاس'] },
  { governorate: 'الشرقية', cities: ['الزقازيق', 'العاشر من رمضان', 'بلبيس', 'فاقوس'] },
  { governorate: 'البحيرة', cities: ['دمنهور', 'كفر الدوار', 'إيتاي البارود', 'رشيد'] },
  { governorate: 'كفر الشيخ', cities: ['كفر الشيخ', 'دسوق', 'بيلا', 'فوه'] },
  ...
  { governorate: 'السويس', cities: ['السويس'] },
  { governorate: 'شمال سيناء', cities: ['العريش', 'رفح', 'الشيخ زويد'] },
  { governorate: 'جنوب سيناء', cities: ['شرم الشيخ', 'دهب', 'نويبع', 'الطور'] },
  { governorate: 'البحر الأحمر', cities: ['الغردقة', 'سفاجا', 'القصير', 'مرسى علم'] },
  { governorate: 'الفيوم', cities: ['الفيوم', 'سنورس', 'إطسا'] },
  { governorate: 'بني سويف', cities: ['بني سويف', 'الواسطى', 'ناصر'] },
  { governorate: 'المنيا', cities: ['المنيا', 'ملوي', 'سمالوط', 'بني مزار'] },
  { governorate: 'أسيوط', cities: ['أسيوط', 'منفلوط', 'ديروط', 'القوصية'] },
  { governorate: 'سوهاج', cities: ['سوهاج', 'جرجا', 'أخميم', 'طما'] },
  { governorate: 'قنا', cities: ['قنا', 'نجع حمادي', 'قفط', 'دشنا'] },
  ...
  { governorate: 'مطروح', cities: ['مرسى مطروح', 'العلمين', 'سيوة'] },
];
