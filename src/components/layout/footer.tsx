...
const InstagramIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg {...props} xmlns="http://www.w3org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5" /><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" /><line x1="17.5" x2="17.51" y1="6.5" y2="6.5" /></svg>
);
    ...
    <footer className="bg-secondary/50 text-secondary-foreground border-t">
      <div className="container py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li className="flex items-center">
                ...
                <span className="ms-3 text-sm" dir="ltr">+966 12 345 6789</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 shrink-0 text-primary" />
                <span className="ms-3 text-sm">contact@startak.com</span>
              </li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-12 border-t border-border pt-8 text-center text-sm text-muted-foreground">
          <p>&copy; {currentYear} ستارتك. جميع الحقوق محفوظة.</p>
        </div>
      </div>
    </footer>
  );
